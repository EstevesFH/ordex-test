...
export const CategoryBadge = styled.span<CategoryBadgeProps>`
  ...
  font-size: 12px;
  font-weight: 600;
  background: ${props => props.category === 'durable' ? 'rgba(59, 130, 246, 0.1)' : 'rgba(245, 158, 11, 0.1)'};
  color: ${props => props.category === 'durable' ? '#93c5fd' : '#fcd34d'};
  border: 1px solid ${props => props.category === 'durable' ? 'rgba(59, 130, 246, 0.3)' : 'rgba(245, 158, 11, 0.3)'};
`
